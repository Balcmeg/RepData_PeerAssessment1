...
```{r}
ActivityData2$wday<-weekdays(ActivityData2$rday)
ActivityData2$wdayfact<- as.factor(c("weekend", "weekday"))
#ActivityData2$wday[ActivityData2$wday == "Sunday" | ActivityData2$wday == "Saturday" ,5]<- factor("weekend")
#ActivityData2$wday[!(ActivityData2$wday == "Sunday" | ActivityData2$wday == "Saturday"),5 ]<- factor("weekday")
```
